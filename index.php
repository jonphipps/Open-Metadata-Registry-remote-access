<?php
  ...
  //uri
  //$_SERVER['REQUEST_URI'] = '/ns/frbr/elements.rdf';
  ...
  $thisNamespace  = "http://iflastandards.info/ns/fr";
  $useFopen = false;
  ...
  $html .=
    <<<HTML
                      <tr>
                    <td colspan="6"><h3 style="margin-top: 10px; padding: 0;">FRBR Vocabularies</h3></td>
                  </tr>
HTML;
